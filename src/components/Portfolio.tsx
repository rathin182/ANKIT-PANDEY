...
const projects: Project[] = [
  {
    ...
    tags: ["SEO", "Paid Ads"],
    results: ["250% Revenue Increase", "180% Conversion Rate", "300% Organic Traffic"],
    imageUrl:
      "/protfollio/1.jpg",
  },
  {
    ...
    tags: ["LinkedIn Ads", "Content Marketing"],
  ...
  },
  {
    ...
    tags: ["Product Launch", "Growth Hacking"],
  ...
  },
  {
    ...
    tags: ["Local SEO", "Healthcare Marketing"],
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore real case studies and campaigns that delivered exceptional results
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-3xl p-12">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Let's discuss your business goals and create a customized strategy
              that delivers measurable results for your industry.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 whitespace-nowrap cursor-pointer">
                Start Your Project
              </button>
              <button className="border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 whitespace-nowrap cursor-pointer">
